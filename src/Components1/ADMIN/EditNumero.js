...
const NumeroForm = ({ row = {}, onClose }) => {
    ...
    const [actif, setActif] = useState(row.actif === true || row.actif === "true");
    const [affectation, setAffectation] = useState(row.affectation || false); // Nouveau état
    ...
    const handleSubmit = async (event) => {
        ...
        const formData = {
            ...
            operateur,
            actif,
            affectation, // Inclure l'affectation
            forfait,
            fillialeLibelle
        };
                    ...
                    <Grid item xs={12} sm={6}>
                        <FormControlLabel
                            control={
                                <Checkbox
                                    checked={affectation}
                                    disabled // Rend le Checkbox non modifiable
                                />
                            }
                            label="Affectation"
                        />
